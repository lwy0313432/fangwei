<{include file="header.tpl"}>
    ...
    <div  class="login">
        ...
        <div  class="login-1">
           ...
           <div style='clear:both;height:15px;'></div>
            <div  class="login-1-1">
                &nbsp;&nbsp;&nbsp;验证码：  <input type="text" name="vcode"  placeholder="&nbsp;&nbsp;输入右方字符" style='width:124px;'/> <img src="/Vcode/index" onclick="this.src='/Vcode/index?'+Math.random()" style='width:69px;height:31px;position:relative;top:10px;'/>&nbsp;&nbsp;<span class="qiehuan"  >换一张</span>
            </div>
            <div style='clear:both;height:15px;'></div>
